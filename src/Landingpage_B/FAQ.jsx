...
const FAQ = () => {
  return (
    <div className="bg-white mx-28 py-16 ">
      <h1 className="text-4xl font-bold mb-8 text-[#590E87]">FAQ</h1>
      {faqData.map((item, index) => (
        <div key={index} className="rounded-lg overflow-hidden relative">
          ...
          <div className="bg-white border-solid border-2 border-yellow-100 rounded-b-lg p-4 mb-2">
